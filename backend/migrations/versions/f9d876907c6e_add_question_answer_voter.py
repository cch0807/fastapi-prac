...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["question_id"],
            ["question.id"],
            name=op.f("fk_question_Voter_question_id_question"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], name=op.f("fk_question_Voter_user_id_user")
        ),
        sa.PrimaryKeyConstraint(
            "user_id", "question_id", name=op.f("pk_question_Voter")
        ),
    )
    op.create_table(
        "answer_voter",
        ...
        sa.ForeignKeyConstraint(
            ["answer_id"], ["answer.id"], name=op.f("fk_answer_voter_answer_id_answer")
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], name=op.f("fk_answer_voter_user_id_user")
        ),
